 ...
 * route, so it can't be a plain NavItem/NavLink. Styled to match the other
 * (route-backed) items in the Overview list.
 */
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            aria-label={label}
            onClick={open}
            className="flex size-8 shrink-0 items-center justify-center rounded-md text-muted transition-colors motion-safe:duration-150 hover:bg-surface-elevated/40 hover:text-foreground"
          >
